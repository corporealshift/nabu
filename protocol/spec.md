...
Turns and tokens per calendar day in the daemon's time zone, across the sessions
`nabu.session.list` returns, oldest day first. Every day in the range is present, a quiet
